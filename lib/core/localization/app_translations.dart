...
class AppTranslations extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    ...
    'ru': {
      ...
      'asset_info_loc': 'Статус и расположение',
      'asset_responsible': 'Ответственное лицо',
      'asset_history': 'История и перемещения',
      'btn_transfer': 'Переместить',
      'asset_delete_title': 'Удалить оборудование',
      'asset_delete_confirm': 'Вы уверены, что хотите удалить это оборудование?',
      'asset_add_title': 'Добавить новое оборудование',
      'asset_inp_name': 'Название (Стол, Ноутбук...)',
      'asset_inp_model': 'Модель',
      'asset_inp_serial': 'Серийный номер',
      'asset_inp_color': 'Цвет',
      'asset_transfer_title': 'Перемещение оборудования',
      'asset_transfer_curr': 'Текущее расположение',
      ...
      'col_payment_status': 'СТАТУС ОПЛАТЫ',
      'col_no': '#',
    ...
    'tr': {
      ...
      // Assets View
      'assets_title': 'Envanter',
      'assets_subtitle': 'Organizasyon varlıkları ve pasaportları',
      'assets_search': 'Ara...',
      'assets_building': 'Bina',
      'assets_floor': 'Kat',
      'assets_room': 'Oda',
      'assets_manage_loc': 'Bina ve Oda Yönetimi',
      'assets_add_new': 'Yeni Ekle',
      'assets_select_label': 'Seçmek için',
      'assets_count_unit': 'adet',
      'assets_view_rooms': 'Odaları gör',
      'assets_view_floors': 'Katları gör',
      'assets_view_items': 'Eşyaları gör',
      'asset_passport_title': 'VARLIK PASAPORTU',
      ...
      'asset_inp_model': 'Model',
      'asset_inp_serial': 'Seri No',
      'asset_inp_color': 'Renk',
      'asset_transfer_title': 'Varlık Taşıma',
      ...
      'col_payment_status': 'ÖDEME DURUMU',
      'col_no': '#',
